...
export const curations: Curation[] = [
  ...
  },
  {
    ...
    description: 'Необычные ингредиенты и неожиданные сочетания — умами, соевый соус, янтарный мёд, пшеничный ликёр. Коктейль за пределами привычного.',
    descriptionEn: 'Unusual ingredients and unexpected combinations — umami, soy sauce, amber honey. The cocktail beyond the ordinary.',
