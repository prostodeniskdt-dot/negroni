const ru: Record<string, string> = {
  ...
  'hero.title': '100+ вариаций по России',
  'hero.subtitle': 'Музей коктейлей',
  'hero.desc': 'Классические рецепты и современные твисты со всей России и СНГ',
  ...
  'index.historyBody': 'История коктейля началась в 1919 году во Флоренции, когда бармен усилил «Americano» джином — так родился эталон горького, сладкого и сухого вкуса.',
  'index.historyLink': 'Полная история →',
  'index.collectionTitle': 'Коллекция',
  // About
  'about.title': 'О музее и команде',
  'about.subtitle': 'от команды BAR BOSS ONLINE',
  'about.p1': 'Музей начался с офлайн-стенда на профессиональном барном событии, где команда собрала более 100 рецептов из баров и команд по всей стране. Каждый участник привозил свою интерпретацию классики — с локальными биттерами, ягодами, медом, травами и сезонными ингредиентами.',
