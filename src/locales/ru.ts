const ru: Record<string, string> = {
  ...
  'hero.desc': 'Классические рецепты Негрони и современные твисты со всей России и СНГ',
  'hero.cta': 'Открыть карту рецептов',
  'hero.secondary': 'Смотреть полную коллекцию',
  'hero.meta': 'онлайн-коллекция, коктейли | Негрони • 2025',
  'hero.articleTitle': 'Музей Негрони — классика и авторские подачи',
  'hero.articleSubtitle': 'The Negroni Museum — Bitter, Sweet, Timeless',
  'hero.articleP1': 'Музей Негрони родился как офлайн-стенд на барном фестивале, а теперь переходит в аккуратный онлайн-формат с проверенными рецептами и партнёрскими продуктами.',
  'hero.articleP2': 'В коллекции — классика, итальянские предки Негрони и авторские подачи баров из России и СНГ.',
  'hero.articleP3': 'Откройте карту или коллекцию, чтобы изучить рецепты, технику приготовления и идеи для барной карты или домашнего бара.',
  'hero.articleFooter': 'Музей Негрони • классика и авторские подачи • Проект команды Бар Босс Онлайн, основатель — Виталий Аршук',
  'hero.statsRecipes': 'Рецептов',
  ...
  'about.subtitle': 'от команды BAR BOSS ONLINE',
  'about.p1': 'Музей Негрони начался с офлайн-стенда на профессиональном барном событии, а сейчас развивается как онлайн-коллекция проверенных рецептов и партнёрских продуктов.',
  ...
  'recipe.export': 'Скачать PDF',
  'recipe.exporting': 'Готовим PDF…',
  'recipe.exportFailed': 'Не удалось собрать PDF. Попробуйте ещё раз.',
  ...
  'favorites.export': 'Скачать PDF',
  'favorites.exportPick': 'Выбрать рецепты',
  'favorites.exportSelected': 'Скачать выбранные',
  'favorites.exportCancel': 'Отмена',
  'collection.exportFound': 'PDF найденных',
  'collection.exportAll': 'PDF всей коллекции',
  'collection.exportPick': 'Выбрать для PDF',
  'collection.exportSelected': 'Скачать выбранные',
  'collection.exportCancel': 'Отмена выбора',
  ...
  'history.desc': 'От флорентийского бара до современных авторских подач — путешествие длиной больше века.',
  'history.1806.title': 'Рождение слова cocktail',
  'history.1806.desc': 'В печати впервые появляется слово «cocktail», что позже станет отправной точкой для золотого века смешанных напитков.',
  'history.1860.title': 'Основание Campari',
  'history.1860.desc': 'Гаспаре Кампари создаёт бренд Campari — будущий базовый элемент классического Негрони.',
  'history.1868.title': 'Рождение Камилло Негрони',
  'history.1868.desc': '25 мая 1868 года во Флоренции рождается Камилло Лукано Карло Негрони.',
  ...
  'history.1920.desc': 'Негрони выходит за пределы Италии: сначала США, затем Европа, где его популярность стремительно растёт.',
  'history.1943.title': 'Первые публикации',
  'history.1943.desc': 'Коктейль Негрони начинает регулярно упоминаться в профессиональной печати.',
  'history.1960.title': 'Поп-культурный след',
  'history.1960.desc': 'Иэн Флеминг вводит Негрони в книжный мир Джеймса Бонда, укрепляя статус коктейля в массовой культуре.',
  'history.2003.title': 'Новая мировая классика',
  'history.2003.desc': 'The New York Times публикует материал о Негрони как о новой классике; напиток закрепляется в глобальной барной культуре.',
  'history.2013.title': 'Negroni Week',
  'history.2013.desc': 'Стартует первая Negroni Week. С тех пор инициатива ежегодно собирает миллионы долларов на благотворительность.',
  'history.2024.title': 'Глобальное признание',
  'history.2024.desc': 'Сегодня Негрони — один из самых узнаваемых и востребованных коктейлей мира, символ культуры аперитива.',
  'history.2024.link': 'Смотреть коллекцию →',
  ...
  'partners.catalogNote': 'В каталоге — джин Bartenders United и рецепты коллекции, где он подходит для подачи.',
  ...
  'partners.contactPartner': 'Связаться с партнёром',
  'partners.orderByPhone': 'Заказать по телефону',
  ...
  // Footer
  'footer.rights': '© 2025 Музей Негрони. Все права защищены. Проект команды Бар Босс Онлайн. Основатель — Виталий Аршук.',
