const ru: Record<string, string> = {
  ...
  'hero.articleP2': 'Сейчас в коллекции представлены классический Негрони и Ярославский Негрони от Александры Таран из бара Good Karma.',
  ...
  'hero.statsRecipes': 'Рецепта',
  'hero.statsCities': 'Города',
  ...
  'collection.desc': 'Проверенные рецепты музея: классический Негрони и авторская ярославская подача.',
